...
// ------------------------------------------------------------------------------------------------------------------------------------------------------->>
    ...
    #define FIRMWARE_VERSION        "0.93.71"      // version. Last update 9/7/2020
    
    #define MIN_OPCONFIG_VERSION    "0.93.71"      // Minimum version of OP Config this version of firmware requires
