...
public:
    ...
    int GetDriveSpeed(int, int, _driveModes, boolean, int, int);   // What is the *drive* speed. This is used to control the tank movement. // two integers added for max forward/reverse speed, plus the motor type
